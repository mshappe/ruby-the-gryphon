...
ActiveRecord::Schema.define(version: 20_171_225_204_703) do
  ...
  add_index 'addresses', %w[latitude longitude], name: 'index_addresses_on_latitude_and_longitude', using: :btree
  ...
  add_index 'event_event_activity', %w[event_activity_id event_id], name: 'index_event_event_activity_on_event_activity_id_and_event_id', using: :btree
  add_index 'event_event_activity', %w[event_id event_activity_id], name: 'index_event_event_activity_on_event_id_and_event_activity_id', using: :btree
  ...
  add_index 'treaties', %w[treaty_type_type treaty_type_id], name: 'index_treaties_on_treaty_type_type_and_treaty_type_id', using: :btree
