...
ActiveRecord::Schema.define(version: 20181028211506) do
  ...
  create_table "award_recipients", force: :cascade do |t|
    ...
    t.integer  "award_recipient_thumbnail_file_size",    limit: 8
    ...
    t.integer  "award_recipient_image_file_size",        limit: 8
  ...
  create_table "awards", force: :cascade do |t|
    ...
    t.integer  "award_badge_file_size",    limit: 8
  ...
  add_index "library_documents", ["library_section_id"], name: "index_library_documents_on_library_section_id", using: :btree
  add_index "library_documents", ["post_id"], name: "index_library_documents_on_post_id", using: :btree
  ...
  create_table "people", force: :cascade do |t|
    ...
    t.integer  "heraldic_image_file_size",    limit: 8
  ...
  create_table "personas", force: :cascade do |t|
    ...
    t.integer  "persona_image_file_size",    limit: 8
  ...
  create_table "reigns", force: :cascade do |t|
    ...
    t.integer  "reign_image_file_size",        limit: 8
    ...
    t.integer  "reign_map_file_size",          limit: 8
  ...
  create_table "warrant_types", force: :cascade do |t|
    ...
    t.integer  "warrant_badge_file_size",    limit: 8
  ...
  add_foreign_key "library_documents", "library_sections"
  add_foreign_key "library_documents", "posts"
